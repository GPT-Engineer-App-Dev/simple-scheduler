    ...
    <div className="container mx-auto p-4">
      ...
      <ul className="list-none">
        {todos.map((todo, index) => (
          <li key={index} className="flex justify-between items-center p-2 bg-base-200 rounded my-2">
            <span>{todo}</span>
            <button className="btn btn-circle btn-outline btn-error" onClick={() => handleDeleteTodo(index)}>
              <FaTrash />
            </button>
          </li>
        ))}
